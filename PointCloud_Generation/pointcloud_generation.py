...
class PointCloudGenerator:
    ...
    def generate_pointcloud(
        self, target_names: list[str], need_confirm=True, blockages: list = None, valid_region: list = None,
    ):
        """
        bloackages[
            [minX, minY, maxX, maxY],
        ...
        for box in boxes:
            ...
            if valid_region is not None:
                if box.box[0] < valid_region[0] or box.box[1] < valid_region[1] or box.box[2] > valid_region[2] or box.box[3] > valid_region[3]:
                    raise ValueError(f"Detected {box.phrase} out of region") 
