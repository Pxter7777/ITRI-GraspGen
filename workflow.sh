...
$python ./main_zed.py --use-yolo --exit-after-save --output-tag $TIMESTAMP
$python ./manual_PC_transform.py --quick --filename scene_$TIMESTAMP.json --transform-config demo5.json
